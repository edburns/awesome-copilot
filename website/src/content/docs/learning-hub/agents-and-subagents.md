...
As of **v1.0.71**, the default maximum nesting depth was reduced from 6 to 4. Usage-based billing users can increase this up to 128 via `subagents.maxDepth` in `/settings`.
