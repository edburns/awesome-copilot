...
Yes, since v1.0.72+. **Multi-turn subagents are always enabled** — you can send follow-up messages to a running subagent without any special configuration. This means you can steer a subagent mid-task, ask it to adjust its approach, or provide additional context as it works.
