...
Installed skills appear in `copilot skill list` and are automatically used when an agent determines they are relevant to the current task. Remove a skill with:
